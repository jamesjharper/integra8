...
#[cfg(feature = "tokio-runtime")]
pub fn timeout<T: futures::Future>(duration: std::time::Duration, future: T) -> tokio::time::Timeout<T> {
...
#[cfg(feature = "async-std-runtime")]
pub async fn timeout<F, T>(duration: std::time::Duration, future: F) -> Result<T, async_std::future::TimeoutError>
where
