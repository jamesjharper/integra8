...
pub fn main_test(input_tokens: TokenStream) -> TokenStream {
    ...
    let tokens = quote! {
        ...
        type ExecutionContext = #integra8_path ::runner::context::ExecutionContext<Parameters>;
        ...
        pub mod command_line {
            ...
            > {
                fn create_formatter(&self) -> Option<Box<dyn #integra8_path ::formaters::OutputFormatter>> {
                    let formatters = < #formatter_factory_type as #integra8_path ::formaters::OutputFormatterFactory>::create(
